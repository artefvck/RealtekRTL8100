...
#ifndef RealtekRTL8100_linux_h
#define RealtekRTL8100_linux_h
...
do                                                                             \
{                                                                              \
IOLog("[RealtekRTL8100] " format, ##args);                             \
} while (0)
...
#define net_device rtl8101_private
#define netdev_priv(x)  ((struct rtl8101_private *)x)
